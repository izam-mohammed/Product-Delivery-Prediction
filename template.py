...
project_name = "deliveryPrediction"
...
project_head = "Product Delivery Prediction"
repo_name = "Product-Delivery-Prediction"
short_description = "A repository for predict whether the product will deliver or not"
